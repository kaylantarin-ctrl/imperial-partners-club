...
export const metadata = {
  title: 'Ecosystem — Imperial Partners Club',
};
        ...
        >
          <div className="wrap py-24">
            ...
            <p className="text-white/75 max-w-[680px] mt-6 font-light leading-relaxed">
              This page will showcase the Imperial Partners Club ecosystem, including solutions, partners, support, resources, and global opportunities.
            </p>
            <div className="mt-10">
