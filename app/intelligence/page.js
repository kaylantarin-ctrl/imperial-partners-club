...
export const metadata = {
  title: 'Intelligence — Imperial Partners Club',
};
        ...
        >
          <div className="wrap py-24">
            ...
            <p className="text-white/75 max-w-[680px] mt-6 font-light leading-relaxed">
              This page will showcase the Imperial Partners Club intelligence capabilities, including data insights, analytics, and strategic guidance.
            </p>
            <div className="mt-10">
